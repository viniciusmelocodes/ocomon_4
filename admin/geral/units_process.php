...
if ($data['action'] == 'new') {
    ...
    $sql = "SELECT inst_cod FROM instituicao WHERE inst_nome = '" . $data['unit_name'] . "' ";
    $res = $conn->query($sql);
    if ($res->rowCount()) {
        $data['success'] = false; 
        $data['field_id'] = "unit_name";
    ...
    $sql = "SELECT inst_cod FROM instituicao WHERE inst_nome = '" . $data['unit_name'] . "' AND inst_cod <> '" . $data['cod'] . "'";
    $res = $conn->query($sql);
    if ($res->rowCount()) {
        $data['success'] = false; 
        $data['field_id'] = "unit_name";
