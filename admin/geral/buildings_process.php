...
if ($data['action'] == 'new') {
    ...
    $sql = "SELECT pred_cod FROM predios WHERE pred_desc = '" . $data['building_name'] . "' ";
    $res = $conn->query($sql);
    if ($res->rowCount()) {
        $data['success'] = false; 
        $data['field_id'] = "building_name";
    ...
    $sql = "SELECT pred_cod FROM predios WHERE pred_desc = '" . $data['building_name'] . "' AND pred_cod <> '" . $data['cod'] . "'";
    $res = $conn->query($sql);
    if ($res->rowCount()) {
        $data['success'] = false; 
        $data['field_id'] = "building_name";
