...
if ($data['action'] == 'new') {
    ...
    $sql = "SELECT * FROM `" . $data['database'] . "`." . $data['table'] . " WHERE " . $data['table_cost_description'] . " = '" . $data['costcenter_name'] . "' OR  " . $data['table_cost_number'] . " = '" . $data['costcenter_number'] . "'";
    $res = $conn->query($sql);
    if ($res->rowCount()) {
        $data['success'] = false; 
        $data['field_id'] = "costcenter_name";
    ...
    $sql = "SELECT * FROM `" . $data['database'] . "`." . $data['table'] . " WHERE (" . $data['table_cost_description'] . " = '" . $data['costcenter_name'] . "' OR  " . $data['table_cost_number'] . " = '" . $data['costcenter_number'] . "') AND " . $data['table_id'] . " <> '" . $data['cod'] . "'";
    $res = $conn->query($sql);
    if ($res->rowCount()) {
        $data['success'] = false; 
        $data['field_id'] = "costcenter_name";
