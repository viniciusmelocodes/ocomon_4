				...
				<table id="table_lists" class="stripe hover order-column row-border" border="0" cellspacing="0" width="100%">
					...
					<tbody>
						...
						foreach ($resultado->fetchall() as $row) {
						    ...
						    ?>
							<tr>
                                <td class="line"><?= $row['descricao']; ?></td>
                                <td class="line"><?= $row['codccusto']; ?></td>
		...
		if ((isset($_GET['action']) && $_GET['action'] == "edit") && empty($_POST['submit'])) {
			...
			<form method="post" action="<?= $_SERVER['PHP_SELF']; ?>" id="form">
				...
				<div class="form-group row my-4">
					<label for="costcenter_name" class="col-md-2 col-form-label col-form-label-sm text-md-right"><?= TRANS('DESCRIPTION'); ?></label>
					<div class="form-group col-md-10">
						<input type="text" class="form-control " id="costcenter_name" name="costcenter_name" value="<?= $row['descricao']; ?>" required />
                    </div>

                    <label for="costcenter_number" class="col-md-2 col-form-label col-form-label-sm text-md-right"><?= TRANS('COL_CODE'); ?></label>
					<div class="form-group col-md-10">
						<input type="text" class="form-control " id="costcenter_number" name="costcenter_number" value="<?= $row['codccusto']; ?>" required />
                    </div>
