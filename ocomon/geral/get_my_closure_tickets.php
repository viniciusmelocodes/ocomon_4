...
$sql = $QRY["ocorrencias_full_ini"] . " where o.operador = " . $_SESSION['s_uid'] . " and s.stat_painel in(3) order by numero DESC ";
$sqlResult = $conn->query($sql);
$totalData = $sqlResult->rowCount();
$totalFiltered = $totalData;  // when there is no search parameter then total number rows = total number filtered rows.

$sql = $QRY["ocorrencias_full_ini"] . " where o.operador = " . $_SESSION['s_uid'] . " and s.stat_painel in(3) ";
