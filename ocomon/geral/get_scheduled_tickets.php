...
$sql = $QRY["ocorrencias_full_ini"] . " WHERE o.oco_scheduled=1 and o.sistema in (" . $uareas . ") ORDER BY numero";
$sqlResult = $conn->query($sql);
$totalData = $sqlResult->rowCount();
$totalFiltered = $totalData;  // when there is no search parameter then total number rows = total number filtered rows.


$sql = $QRY["ocorrencias_full_ini"] . " WHERE o.oco_scheduled=1 and o.sistema in (" . $uareas . ") ";
