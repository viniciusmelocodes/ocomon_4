...
<body>
    ...
    <script>
        ...
        /* Redirecionamento para a tela de detalhes da ocorrencia */
            ...
            $('#table_my_inactive,#table_my_linked,#table_my_closure,#table_my_tickets').on('mouseout', 'td', function() {
                $(this).popover('dispose');
                $('.popover').remove();
            });

            /* Popovers para os indicadores de interação com o chamado (primeira coluna) */
            $('#table_my_inactive,#table_my_linked,#table_my_closure,#table_my_tickets').on('mouseover', '.ticket-interaction', function() {
