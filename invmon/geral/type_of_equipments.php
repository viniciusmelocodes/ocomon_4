...
<body>
	...
	<div class="container-fluid">
		<h4 class="my-4"><i class="fas fa-laptop text-secondary"></i>&nbsp;<?= TRANS('ADM_EQUIP_TYPE'); ?></h4>
		...
		$query = "SELECT * FROM tipo_equip ";

		if (isset($_GET['cod'])) {
			$query .= " WHERE tipo_cod = ".$_GET['cod']."  ";
		}
        $query .= " ORDER BY tipo_nome";
